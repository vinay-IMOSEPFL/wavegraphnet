...
PAPER_GLOBAL_ARGS = [
    ...
    "--batch_size",   "8",
    "--epochs",       "500",
    "--num_fft_bins", "256",  # 256 bins between 69.4–128 kHz (lookback_fft=510)
]
...
# Default scripts (when --paper is NOT set) — original behaviour.
DEFAULT_SCRIPTS = [
    ("main_cnn.py",              [],                         "1D CNN"),
    ("main_lstm.py",             [],                         "LSTM"),
...
def main():
    ...
    parser.add_argument("--paper", action="store_true",
                        help="Use exact paper hyperparameters: "
                             "lr=1e-4, batch=8, epochs=500, 256 FFT bins, "
    ...
    parser.add_argument("--num_fft_bins", type=int,   default=None,
                        help="Override number of FFT frequency bins")
    ...
    for flag, val in [
        ...
        ("--lr",           args.lr),
        ("--num_fft_bins", args.num_fft_bins),
    ]:
        if val is not None:
